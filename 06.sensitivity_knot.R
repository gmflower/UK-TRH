...
################################################################################
# SENSITIVITY ANALYSIS - EXPOSURE RESPONSE (1 KNOT) (REPRODUCIBLE FROM LINE 166)
################################################################################
...
################################################################################
# CHECKS, CLEAN, AND SAVE  AND TRANSFORM
...
# SAVE
saveRDS(stage1list, "./data/stage1list_sensknot.RDS")
...
stage1list <- readRDS("./data/stage1list_sensknot.RDS")
...
saveRDS(pooled_results_list_c, "./temp/pooled_results_sensknot.RDS")
...
pdf("./figures/supplementary/combined_forest_plot_sensknot.pdf", height=6.5, width=16)
...
# SAVE
ggsave("./figures/supplementary/combined_forest_plot_sensknot.png", png_plot, height=7, width=14, dpi=1200)
write.csv(all_plot_data, file="./tables/forest_plot_data_sensknot.csv")
